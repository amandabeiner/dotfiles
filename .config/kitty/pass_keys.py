...
def is_window_vim(window, vim_id):
    ...
    print("vim_id", vim_id)
    print(fp)
    match = any(re.search(vim_id, p['cmdline'][0], re.I) for p in fp)
    print("match", match)
...
def handle_result(args, result, target_window_id, boss):
    ...
    print("target window id", target_window_id)
    print("id map", boss.window_id_map)
    direction = args[2]
    key_mapping = args[3]
    ...
    if is_window_vim(window, vim_id):
        ...
        print("window is something else")
